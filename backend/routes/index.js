...
router.post('/sendEmail', function(req, res, next) {
    ...
    text: 'Done',
    html: `<img src=${req.body.image} height="200" width="200"><br><br><button onclick="accept()" class=btn btn-primary>Accept</button><button class=btn btn-danger>Reject</button>`
  }
